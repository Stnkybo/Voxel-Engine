    ...
    uint8_t blockType, int faceDir, int cornerIdx, int quadWidth, int quadHeight)
{
    ...
    glm::vec2 baseUV = blockTextureAtlas.GetUVOffset(blockType, faceDir);

    // Each tile size in UV space
    float tileU = 1.0f / ATLAS_COLS;
    float tileV = 1.0f / ATLAS_ROWS;
    ...
    switch (cornerIdx) {
        case 0: uOffset = 0.0f;           vOffset = 0.0f;           break; // bottom-left
        case 1: uOffset = quadWidth * tileU; vOffset = 0.0f;         break; // bottom-right
        case 2: uOffset = quadWidth * tileU; vOffset = quadHeight * tileV; break; // top-right
        case 3: uOffset = 0.0f;           vOffset = quadHeight * tileV; break; // top-left
    }
